                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-container">
                            ...
                            <p class="p-heading p-large">Surely, of all the wonders of the world, the horizon is the greatest.” – Freya Stark</p>
                            <a class="btn btn-primary" href="schedules.php" role="button">Book a Ticket ></a>
